...
# ============================================================
# Config — 凭据仅从环境变量获取，严禁硬编码
# ============================================================
APPID = os.environ.get("WEIXIN_APPID") or os.environ.get("WECHAT_APPID")
APPSECRET = os.environ.get("WEIXIN_APPSECRET") or os.environ.get("WECHAT_APPSECRET")
...
def main():
    ...
    if not APPID or not APPSECRET:
        print("❌ 未设置微信 API 凭据。请设置环境变量：")
        print("   export WEIXIN_APPID=\"你的AppID\"")
        print("   export WEIXIN_APPSECRET=\"你的AppSecret\"")
        print("   获取路径：公众号后台 → 开发 → 基本配置")
        sys.exit(1)
